...
bool PlatformCreateWindow(const char* title, int width, int height)
{
    ...
    //Fake Window init OpenGL
    {
        ...
        wglSwapIntervalEXT_ptr = (PFNWGLSWAPINTERVALEXTPROC)PlatformLoadGLFunction("wglSwapIntervalEXT");
...
void PlatformUpdateWindow()
{
    ...
    //clear the transition for every key
...
{
    wglSwapIntervalEXT_ptr(enabled);
}
